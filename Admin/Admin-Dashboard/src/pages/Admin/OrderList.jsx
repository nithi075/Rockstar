...
export default function OrderList() {
  ...
  // Function to handle updating order status to 'Delivered'
  const handleDeliverOrder = async (orderId) => {
    setUpdatingOrderId(orderId); // Set the ID of the order being updated
    try {
      ...
      if (res.data.success) {
        ...
        toast.success("Order status updated to Delivered!"); // Show success message
      } else {
