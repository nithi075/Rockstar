...
exports.updateProduct = catchAsyncErrors(async (req, res, next) => {
    ...
    // Ensure only the owner/admin can update their products if user field is present
    // if (product.user.toString() !== req.user.id && req.user.role !== 'admin') {
    //     return next(new ErrorHandler(`User is not authorized to update this product`, 403));
    // }
